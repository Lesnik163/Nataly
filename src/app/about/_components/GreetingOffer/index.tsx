...
const listItemClasses = {
  item1:
    'font-medium text-rose-700 opacity-0 before:mr-3 before:text-rose-500 before:content-["→"] animate-[slideInRight_0.8s_ease-out_forwards]',
  item2:
    'font-medium text-rose-700 opacity-0 before:mr-3 before:text-rose-500 before:content-["→"] animate-[slideInLeft_0.8s_ease-out_forwards]',
  item3:
    'font-medium text-rose-700 opacity-0 before:mr-3 before:text-rose-500 before:content-["→"] animate-[slideInRight_0.8s_ease-out_forwards]',
};
...
export const GreetingOffer = () => {
  return (
    <div className='relative my-[100px] w-[320px] rounded-2xl border border-rose-200/50 bg-rose-50/90 p-6 shadow-xl backdrop-blur-sm min-[899px]:w-[740px] min-[899px]:p-8'>
